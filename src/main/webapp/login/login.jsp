            ...
            $("#loginButtonId").click(function () {
                ...
                if(isok){
                    $.ajax({
                        ...
                        type:"post",
                        data:$("#loginForm").serialize(),//表单对象序列化
                        dataType:"JSON",
                        success:function (data) {
                            if (data.status==200){//判断
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required type="text" name="code" id="form-code">
                            </div>
